...
<!-- BEGIN: Content-->
<div class="app-content content" style="background-image: url('{{ asset('images/slide-5.jpg') }}');">
                        ...
                        <div class="card border-grey border-lighten-3 px-1 py-1 m-2">
                            <div class="card-header border-0">
                                <div class="card-title text-center">
                                    <img src="{{ asset('images/logo.png') }}" alt="branding logo" style="width: 50%">
                                </div>
                                    ...
                                    <form class="form-horizontal" action="" method="POST">
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="email"
                                                ...
                                                placeholder="Your Username" name="email" required>
                                            @error('email')
